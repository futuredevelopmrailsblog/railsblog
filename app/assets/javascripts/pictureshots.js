    ...
    var Pictureshots = {
        previewPictureshot() {
            if (window.File && window.FileList && window.FileReader) {
                ...
                const fileInput = document.getElementById('pictureshot_user_pictureshot');
                const previewImage = document.getElementById('previewImage');
                const newPictureshotForm = document.getElementById('new_pictureshot');
        ...
        pictureshotHover() {
            $('.pictureshot').hover(function() {
                $(this).children('.pictureshot-data').toggleClass('visible');
            });
        }

    };
    Pictureshots.previewPictureshot();
    Pictureshots.pictureshotHover();
